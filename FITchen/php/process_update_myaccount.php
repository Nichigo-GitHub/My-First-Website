<?php
	...
	} elseif ( isset( $_POST['change_password'] ) && strlen( $_POST['password'] ) < 8 ) { // check password length
		$status = 'fail';
		$message = 'Password must be at least 8 characters';
	} elseif ( isset( $_POST['change_password'] ) && ( !$_POST['password'] || $_POST['password'] != $_POST['confirm_password'] ) ) { // check password & confirm password if they match
		$status = 'fail';
